...
namespace Expense_Traker.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //List of transactions of the last 6 days 
            ...
            //List of incomes
            List<SplineChartData> IncomeSummary = SelectedTransactions.Where(i => i.Category.Type == "Income").GroupBy(i => i.DateTime)
            ...
            //outcomes
            List<SplineChartData> ExpenseSummary = SelectedTransactions.Where(i => i.Category.Type == "Expense").GroupBy(i => i.DateTime)
               .Select(k => new SplineChartData()
               {
                   day = k.First().DateTime.ToString("dd-MMM"),
            ...
            ViewBag.RecentTransactions = await _context.Transactions.Include(i => i.Category).OrderByDescending(j=> j.DateTime).Take(5).ToListAsync();
